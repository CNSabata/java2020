...
a persistence unit "miniprojetPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "miniprojet\pom.xml":
...
artifacts ("miniprojet-ejb.jar" and "miniprojet-web.war") are already built. You can build
