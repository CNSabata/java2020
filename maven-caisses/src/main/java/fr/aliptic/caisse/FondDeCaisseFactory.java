...
public abstract class FondDeCaisseFactory {
	...
	public FondDeCaisse creerFondDeCaisse(double montant) {
		...
		int[] valeursBillets = infoMonnaie.getValeursBillets();
		double[] valeursPieces = infoMonnaie.getValeursPieces();
		
		// on travaille en centimes pour faire des opérations avec des entiers
